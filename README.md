...
| ------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `@weftjs/core`      | [`0.2.4`](https://www.npmjs.com/package/@weftjs/core)     | The framework. The CLI, the conventions, and what an application imports      |
| `create-weft`       | [`0.1.6`](https://www.npmjs.com/package/create-weft)      | `npm create weft` — a shim over the templates that ship inside `@weftjs/core` |
...
| `@weftjs/compiler`  | [`0.1.6`](https://www.npmjs.com/package/@weftjs/compiler) | TSX to IR, on Oxc, with the type-driven escape class                          |
| `@weftjs/client`    | [`0.1.1`](https://www.npmjs.com/package/@weftjs/client)   | Adoption, signals, deltas, patches, navigation                                |
| `@weftjs/kernel`    | [`0.2.4`](https://www.npmjs.com/package/@weftjs/kernel)   | Routing, the request lifecycle, cache keys, waves, epochs, surgical refresh   |
| `@weftjs/plan`      | [`0.1.6`](https://www.npmjs.com/package/@weftjs/plan)     | The plan DSL, validation against inferred effects, plugins, `weft why`        |
| `@weftjs/adapters`  | [`0.1.6`](https://www.npmjs.com/package/@weftjs/adapters) | The fourteen ports, implemented                                               |
