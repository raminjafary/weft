...
import { clientView, render, TEMPLATE_IR_VERSION, type TemplateIR } from '@weftjs/ir'
import { heldBy, isHeld } from '@weftjs/client'
import { encodeStream, frame, negotiate, type Frame } from '@weftjs/warp'
import { serverCapabilities } from '@weftjs/kernel'
