...
import { bindingExecutor, regionService } from '@weft/adapters'
...
import { regionProbe } from '@weft/kernel'
import type { ChannelSink, RegionBinding, Registry } from '@weft/kernel'
