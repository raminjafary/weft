...
/**
 * The hard case: a signed-in region, `private` because it reads identity — contagion working, not
 * a page turning uncacheable over one personal line. See `spec/compiler/effects.md`. The quantity
 * boxes name an intent rather than a signal: a cart total isn't something a client should guess at.
 */
